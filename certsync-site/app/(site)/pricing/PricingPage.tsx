...
export default function PricingPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "We'll notify you when you're approaching your limit. You can upgrade your plan or contact us to discuss your needs.",
    },
    {
      question: 'Do you offer discounts for annual billing?',
      answer:
        'Yes, we offer a 20% discount for annual billing on all paid plans. Contact us for more information.',
    },
    {
      question: 'Is there a free trial?',
      answer:
        'Yes, Starter and Team plans come with a 14-day free trial. No credit card required to get started.',
    },
    {
      question: 'What support options are available?',
      answer:
        'Starter includes email support, Team includes priority support, and Enterprise includes dedicated support with SLA guarantees.',
    },
  ];
      ...
      <Container maxWidth="xl">
        ...
        >
          ...
          <p className="text-xl text-neutral-600 max-w-2xl mx-auto mb-8">
            ...
            include our core certificate management features.
          </p>
        ...
        >
          {pricingTiers.map((tier) => (
            <motion.div key={tier.name} variants={fadeUpVariants}>
              <Card
                className={`relative ${
