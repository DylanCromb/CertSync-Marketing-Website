...
export default function HomePage() {
  ...
  const employeesInView = useInView(employeesRef, {
    once: true,
    margin: '-100px',
  });
  const employersInView = useInView(employersRef, {
    once: true,
    margin: '-100px',
  });
        ...
        <Container>
          ...
          >
            ...
            <motion.div
              ...
              variants={fadeUpVariants}
            >
              <button className="bg-white text-primary px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-lg focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary">
                Start free trial
              </button>
              <button className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-primary transition-colors text-lg focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary">
                Get the app
              </button>
            </motion.div>
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            >
              <div className="text-center">
                ...
                <button className="bg-primary text-white px-8 py-4 rounded-lg font-semibold hover:bg-primary/90 transition-colors text-lg focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
                  Start free trial
                </button>
              </div>
            </motion.div>
