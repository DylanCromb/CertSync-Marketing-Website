  ...
  const team = [
    {
      ...
      role: 'CEO & Co-founder',
      credibility:
        'Former Head of Security at TechCorp, 15+ years in compliance',
      linkedin: '#',
    },
    {
        ...
        <div className="col-span-12 max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="text-center space-y-4">
              <p className="text-lg text-neutral-600 leading-relaxed">
                After years of watching organizations struggle with expired
                credentials, missed renewals, and compliance nightmares, we knew
                there had to be a better way.
              </p>
              <p className="text-lg text-neutral-600 leading-relaxed">
                We built CertSync to eliminate the chaos of credential
                management, giving both employees and employers the tools they
                need to stay compliant, organized, and stress-free.
              </p>
            </div>
          </motion.section>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {team.map((member) => (
                <motion.div key={member.name} variants={fadeUpVariants}>
