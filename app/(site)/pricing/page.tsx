...
export const metadata: Metadata = {
  title: 'Pricing',
  description: 'Simple, transparent pricing for CertSync. Choose the plan that fits your organization. Starter, Team, and Enterprise plans available.',
  openGraph: {
    title: 'CertSync — Simple, Transparent Pricing',
    description: 'Choose the plan that fits your organization. Starter, Team, and Enterprise plans available.',
  },
};
      ...
      <Container>
        ...
        >
          {pricingTiers.map((tier) => (
            <motion.div
              ...
              variants={fadeUpVariants}
            >
              <div className={`bg-white rounded-lg shadow-sm border-2 p-8 relative ${
                tier.popular ? 'border-primary' : 'border-neutral-200'
              }`}>
                {tier.popular && (
        ...
        >
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div key={index} className="bg-white border border-neutral-200 rounded-lg">
                <button
