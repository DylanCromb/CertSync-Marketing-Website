...
export default function PolicyPage() {
  ...
  const policiesInView = useInView(policiesRef, { once: true, margin: '-50px' });
  ...
  const policies = [
    ...
    },
    {
      ...
      description: 'The terms and conditions governing your use of CertSync services.',
      lastUpdated: '2024-01-15',
      fileSize: '3.1 KB',
    },
    {
      ...
      description: 'Our security measures, data protection practices, and incident response procedures.',
    ...
    },
    {
      ...
      description: 'Terms for processing personal data in compliance with GDPR and other regulations.',
    ...
    },
    {
      ...
      description: 'Guidelines for acceptable use of CertSync services and prohibited activities.',
      lastUpdated: '2024-01-15',
      fileSize: '2.1 KB',
    },
  ];
        ...
        <div className="col-span-12">
          ...
          >
            ...
            <p className="text-xl text-neutral-600 max-w-2xl mx-auto">
              Review our policies and terms to understand how we protect your data and govern our services.
            </p>
          </motion.div>
